...
import com.gcit.springboot.lms.dao.CopyDAO;
...
public class CopyController {
	...
	@RequestMapping(value = "/copies/branches/{branchId}/books/{bookId}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/copies/branches/{branchId}/books/{bookId}", method = RequestMethod.PUT)
